...
- (void)shareToWeixinSession:(XMShareContentType)shareType
{
    ...
    [self shareToWeixinBase:WXSceneSession contentType:shareType];
...
- (void)shareToWeixinTimeline:(XMShareContentType)shareType
{
    ...
    [self shareToWeixinBase:WXSceneTimeline contentType:shareType];
    
}

- (void)shareToWeixinBase:(enum WXScene)scene contentType:(XMShareContentType)shareType
{
